...
#   st.markdown('''[Advert space for Google AdSense3]''')
    ...
    if ScreenSize == "Smartphone - landscape":
        ...
        if   options2 == "Brazil":         lat_2 =-10.00; lon_2 = -55.0; zoom_country = 2.20; markersize = 7; Screen_width =  590; Screen_height = 310
        ...
        if   options2 == "New York City":  lat_2 = 40.80; lon_2 = -73.9; zoom_country = 7.50; markersize = 9; Screen_width =  590; Screen_height = 310
