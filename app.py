...
#       Geo_options = st.selectbox('', df4['Eponym_easy'].unique())
    ...
    if ScreenSize == "Tablet / Laptop / Desktop":                
        ...
        if   options3 == "England":        lat_3 = 53.00; lon_3 =  -3.5; zoom_country = 4.98; markersize = 9; Screen_width =  700; Screen_height = 450
        ...
        if   options3 == "New York City":  lat_3 = 40.80; lon_3 = -73.9; zoom_country = 8.10; markersize = 9; Screen_width =  700; Screen_height = 450
