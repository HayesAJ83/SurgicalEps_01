...
#   st.markdown('''[Advert space for Google AdSense3]''')
    ...
    if ScreenSize == "Smartphone - landscape":
        ...
        if   options2 == "Denmark":        lat_2 = 61.00; lon_2 =  9.80; zoom_country = 5.00; markersize =10; Screen_width =  590; Screen_height = 310
...
#       Geo_options = st.selectbox('', df4['Eponym_easy'].unique())
    ...
    if ScreenSize == "Tablet / Laptop / Desktop":                
        ...
        if   options3 == "Denmark":        lat_3 = 61.00; lon_3 =  9.80; zoom_country = 5.00; markersize =10; Screen_width =  700; Screen_height = 450
