...
#    mapbox_access_token = open("/Users/alastairhayes/desktop/Eponyms/ajhayes83_1.mapbox_token").read()  
        ...
        if   options1 == "London":         lat_country  = 51.52;  lon_country  =  -0.1; zoom_country =   8.5; markersize = 9; Screen_width =  350; Screen_height = 260
        ...
        if   options1 == "New York City":  lat_country  = 40.80;  lon_country  = -73.9; zoom_country =   8.5; markersize = 9; Screen_width =  350; Screen_height = 260
        ...
        if   options1 == "Paris":          lat_country  = 48.86;  lon_country  =  2.35; zoom_country =  10.2; markersize = 9; Screen_width =  350; Screen_height = 260
