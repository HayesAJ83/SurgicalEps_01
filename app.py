...
#       Geo_options = st.selectbox('', df4['Eponym_easy'].unique())
    ...
    if ScreenSize == "Tablet / Laptop / Desktop":                
        ...
        if   options3 == "Canada":         lat_3 = 61.00; lon_3 = -92.0; zoom_country = 1.88; markersize = 9; Screen_width =  700; Screen_height = 450
        if   options3 == "Edinburgh":      lat_3 = 55.90; lon_3 =  -3.2; zoom_country = 9.10; markersize =12; Screen_width =  700; Screen_height = 450
        if   options3 == "England":        lat_3 = 52.80; lon_3 =  -3.0; zoom_country = 5.05; markersize = 9; Screen_width =  700; Screen_height = 450
        if   options3 == "Europe":         lat_3 = 54.40; lon_3 =  10.0; zoom_country = 2.50; markersize = 6; Screen_width =  700; Screen_height = 450
        if   options3 == "France":         lat_3 = 47.00; lon_3 =   3.0; zoom_country = 4.50; markersize = 8; Screen_width =  700; Screen_height = 450
        if   options3 == "Germany":        lat_3 = 51.30; lon_3 =  10.2; zoom_country = 4.20; markersize = 8; Screen_width =  700; Screen_height = 450
        ...
        if   options3 == "Netherlands":    lat_3 = 52.20; lon_3 =   5.0; zoom_country = 5.50; markersize = 9; Screen_width =  700; Screen_height = 450
        if   options3 == "New York City":  lat_3 = 40.80; lon_3 = -73.9; zoom_country = 8.50; markersize = 9; Screen_width =  700; Screen_height = 450
        ...
        if   options3 == "Poland":         lat_3 = 52.50; lon_3 =  19.0; zoom_country =  5.0; markersize = 8; Screen_width =  700; Screen_height = 450
        if   options3 == "South America":  lat_3 =-21.60; lon_3 = -65.0; zoom_country = 1.80; markersize = 9; Screen_width =  700; Screen_height = 450
        if   options3 == "Sweden":         lat_3 = 62.80; lon_3 =  18.5; zoom_country =  3.1; markersize = 8; Screen_width =  700; Screen_height = 450
        if   options3 == "Switzerland":    lat_3 = 47.00; lon_3 =   8.0; zoom_country =  5.9; markersize = 8; Screen_width =  700; Screen_height = 450
