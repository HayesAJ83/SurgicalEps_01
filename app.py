...
#    mapbox_access_token = open("/Users/alastairhayes/desktop/Eponyms/ajhayes83_1.mapbox_token").read()  
    ...
    if ScreenSize == "27-inch":                
        ...
        if   options1 == " ":              lat_country  = 20.00;  lon_country  =  8.0; zoom_country = -0.40; markersize = 10; Screen_width =  640; Screen_height = 480
        if   options1 == "london":         lat_country  = 51.52;  lon_country  = -0.1; zoom_country =  9.80; markersize = 18; Screen_width =  640; Screen_height = 480
