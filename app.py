...
#        if   options3 == "london":         lat_country3  = 51.52;  lon_country3  = -0.1; zoom_country =  9.80; markersize = 5; Screen_width =  700; Screen_height = 450
        ...
        if   options3 == "Europe":         lat_3 = 54.00; lon_3 =  10.0; zoom_country = 2.10; markersize = 6; Screen_width =  700; Screen_height = 450
        if   options3 == "France":         lat_3 = 47.00; lon_3 =   4.0; zoom_country = 4.10; markersize = 8; Screen_width =  700; Screen_height = 450
        if   options3 == "Germany":        lat_3 = 51.25; lon_3 =  10.2; zoom_country = 3.82; markersize = 8; Screen_width =  700; Screen_height = 450
        ...
        if   options3 == "Japan":          lat_3 = 37.70; lon_3 = 135.5; zoom_country = 3.45; markersize = 9; Screen_width =  590; Screen_height = 450
        if   options3 == "London":         lat_3 = 51.52; lon_3 =  -0.1; zoom_country = 8.80; markersize =11; Screen_width =  700; Screen_height = 450
        ...
        if   options3 == "World":          lat_3 = 25.00; lon_3 =  10.0; zoom_country = 0.18; markersize = 6; Screen_width =  700; Screen_height = 450
