...
#    mapbox_access_token = open("/Users/alastairhayes/desktop/Eponyms/ajhayes83_1.mapbox_token").read()  
        ...
        if   options1 == " ":              lat_1 = 40.00;  lon_1 =   0.0; zoom_country = -0.45; markersize = 4; Screen_width =  350; Screen_height = 260
        if   options1 == "All":            lat_1 = 25.00;  lon_1 =   8.0; zoom_country =  1.08; markersize = 6; Screen_width =  350; Screen_height = 260
        if   options1 == "Argentina":      lat_1 =-40.00;  lon_1 = -65.0; zoom_country =   2.5; markersize = 6; Screen_width =  350; Screen_height = 260
        if   options1 == "Austria":        lat_1 = 47.20;  lon_1 =  13.4; zoom_country =  6.50; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "Brazil":         lat_1 =-10.00;  lon_1 = -55.0; zoom_country =   3.0; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "Canada":         lat_1 = 59.00;  lon_1 = -97.0; zoom_country =   1.4; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "Chicago":        lat_1 = 42.00;  lon_1 = -88.0; zoom_country =   8.0; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "Denmark":        lat_1 = 56.00;  lon_1 =   9.8; zoom_country =  4.00; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "Edinburgh":      lat_1 = 55.94;  lon_1 =  -3.2; zoom_country =   9.0; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "Europe":         lat_1 = 54.00;  lon_1 =  10.0; zoom_country =  2.85; markersize = 6; Screen_width =  350; Screen_height = 260
        if   options1 == "France":         lat_1 = 47.00;  lon_1 =   4.0; zoom_country =  4.50; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "Germany":        lat_1 = 51.25;  lon_1 =  10.2; zoom_country =  3.80; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "Hawaii":         lat_1 = 20.50;  lon_1 =-157.4; zoom_country =   6.1; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "Ireland":        lat_1 = 53.50;  lon_1 =  -6.2; zoom_country =   5.0; markersize = 8; Screen_width =  350; Screen_height = 260 
        if   options1 == "Italy":          lat_1 = 41.50;  lon_1 =  14.0; zoom_country =   4.0; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "Japan":          lat_1 = 37.40;  lon_1 = 135.0; zoom_country =   4.4; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "London":         lat_1 = 51.52;  lon_1 =  -0.1; zoom_country =   8.5; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "Netherlands":    lat_1 = 52.00;  lon_1 =   5.0; zoom_country =   4.8; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "New York City":  lat_1 = 40.80;  lon_1 = -73.9; zoom_country =   8.5; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "North America":  lat_1 = 52.00;  lon_1 =  -100; zoom_country =   1.8; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "Paris":          lat_1 = 48.86;  lon_1 =  2.35; zoom_country =  10.2; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "Poland":         lat_1 = 52.00;  lon_1 =  19.0; zoom_country =   4.0; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "South America":  lat_1 =-28.00;  lon_1 = -65.0; zoom_country =   1.8; markersize = 6; Screen_width =  350; Screen_height = 260
        if   options1 == "Sweden":         lat_1 = 62.50;  lon_1 =  18.5; zoom_country =   3.0; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "Switzerland":    lat_1 = 47.00;  lon_1 =   8.0; zoom_country =   4.5; markersize = 8; Screen_width =  350; Screen_height = 260
        if   options1 == "UK":             lat_1 = 54.40;  lon_1 =  -3.2; zoom_country =  3.55; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "USA":            lat_1 = 39.00;  lon_1 =   -96; zoom_country =  2.05; markersize = 9; Screen_width =  350; Screen_height = 260
        if   options1 == "World":          lat_1 = 40.00;  lon_1 =   0.0; zoom_country = -0.45; markersize = 4; Screen_width =  350; Screen_height = 260
...
#       Geo_options = st.selectbox('', df4['Eponym_easy'].unique())
    ...
    if ScreenSize == "Tablet / Laptop / Desktop":                
        ...
        figG3.update_layout(
                ...
                width=Screen_width,
                height=Screen_height,
                mapbox=dict(accesstoken=mapbox_access_token,bearing=0,center=dict(lat=lat_country3,lon=lon_country3),
                pitch=0,
                zoom=zoom_country,
                style='satellite-streets'), #'dark'
            )
