...
#        if   options3 == "london":         lat_country3  = 51.52;  lon_country3  = -0.1; zoom_country =  9.80; markersize = 5; Screen_width =  700; Screen_height = 450
        ...
        if   options3 == "Europe":         lat_3 = 54.00; lon_3 =  10.0; zoom_country = 2.10; markersize = 6; Screen_width =  590; Screen_height = 310
        if   options3 == "France":         lat_3 = 47.00; lon_3 =   4.0; zoom_country = 4.10; markersize = 8; Screen_width =  590; Screen_height = 310
        if   options3 == "Germany":        lat_3 = 51.25; lon_3 =  10.2; zoom_country = 3.82; markersize = 8; Screen_width =  590; Screen_height = 310
        if   options3 == "Hawaii":         lat_3 = 20.50; lon_3 =-157.3; zoom_country = 5.50; markersize = 9; Screen_width =  590; Screen_height = 310
        if   options3 == "Ireland":        lat_3 = 53.50; lon_3 =  -6.2; zoom_country = 5.00; markersize = 9; Screen_width =  590; Screen_height = 310
        if   options3 == "Japan":          lat_3 = 37.70; lon_3 = 135.5; zoom_country = 3.45; markersize = 9; Screen_width =  590; Screen_height = 310
        if   options3 == "London":         lat_3 = 51.52; lon_3 =  -0.1; zoom_country = 8.80; markersize =11; Screen_width =  590; Screen_height = 310
        if   options3 == "Netherlands":    lat_3 = 52.00; lon_3 =   5.0; zoom_country =  4.8; markersize = 8; Screen_width =  590; Screen_height = 310
        if   options3 == "New York City":  lat_3 = 40.80; lon_3 = -73.9; zoom_country = 7.80; markersize = 9; Screen_width =  590; Screen_height = 310
        if   options3 == "North America":  lat_3 = 52.00; lon_3 =  -100; zoom_country =  1.8; markersize = 9; Screen_width =  590; Screen_height = 310
        if   options3 == "Paris":          lat_3 = 48.86; lon_3 =  2.35; zoom_country = 10.2; markersize = 9; Screen_width =  590; Screen_height = 310
        if   options3 == "Poland":         lat_3 = 52.00; lon_3 =  19.0; zoom_country =  4.0; markersize = 8; Screen_width =  590; Screen_height = 310
        if   options3 == "South America":  lat_3 =-28.00; lon_3 = -65.0; zoom_country =  1.4; markersize = 9; Screen_width =  590; Screen_height = 310
        if   options3 == "Sweden":         lat_3 = 62.50; lon_3 =  18.5; zoom_country =  3.0; markersize = 8; Screen_width =  590; Screen_height = 310
        if   options3 == "Switzerland":    lat_3 = 47.00; lon_3 =   8.0; zoom_country =  5.5; markersize = 8; Screen_width =  590; Screen_height = 310
        ...
        if   options3 == "World":          lat_3 = 25.00; lon_3 =  10.0; zoom_country = 0.18; markersize = 6; Screen_width =  590; Screen_height = 310
